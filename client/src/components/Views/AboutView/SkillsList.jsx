    ...
    <article data-testid={TestIds.SKILLS_LIST_ARTICLE_ID}>
      <List className={classes.root}>
        ...
        <ListItem>
          ...
          <ListItemText>
            <span style={{ fontFamily: 'Montserrat, sans-serif' }}>HTML5</span>
          </ListItemText>
        </ListItem>
        <ListItem>
          <ListItemAvatar>
          ...
          <ListItemText>
            <span style={{ fontFamily: 'Montserrat, sans-serif' }}>CSS3</span>
          </ListItemText>
        </ListItem>
        <ListItem>
          <ListItemAvatar>
        ...
        <ListItem>
          ...
          <ListItemText>
            <span style={{ fontFamily: 'Montserrat, sans-serif' }}>GIT</span>
          </ListItemText>
        </ListItem>
      </List>
    </article>
